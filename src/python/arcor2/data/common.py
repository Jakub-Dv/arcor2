...
class Direction(JsonSchemaMixin):
    ...
    @classmethod
    def from_request(cls, request: Request) -> Direction:
...
class BodyJointId(IntEnum):
    ...
    @classmethod
    def from_maybe_str_or_default(cls, maybe_str: str | None) -> BodyJointId:
    ...
    @classmethod
    def from_int(cls, i: int) -> BodyJointId:
        for e in cls:
            if e == i:
                return e
        raise ValueError("Wrong value provided for BodyJointId, expected one of 0 through 31")
