...
class DataclassResponse(Response):
    def __init__(
        self, dc: JsonSchemaMixin, status: int = HTTPStatus.OK, mimetype: str = "application/json", **kwargs
    ) -> None:
        super().__init__(response=dc.to_json(), status=status, mimetype=mimetype, **kwargs)
