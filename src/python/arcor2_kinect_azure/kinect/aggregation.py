...
from arcor2_kinect_azure.kinect.processing import parse_skeleton
...
class Moving(MovingDirection):
    def __init__(
        self,
        compute_buffer: deque[PyK4ACapture],
        body_index: int = 0,
    ...
    def compute(self) -> None:
        ...
        for capture in reversed(self._compute_buffer):
...
class DirectionWithSpeed:
    ...
    def from_request(cls, request: Request) -> "DirectionWithSpeed":
        ...
        direction = Direction.from_request(request)
